...
class AddBatchDimension(YuccaTransform):
	...
	def __call__(self, packed_data_dict = None, **unpacked_data_dict):
		data_dict = packed_data_dict if packed_data_dict else unpacked_data_dict
		data_dict[self.data_key], data_dict[self.seg_key] = self.__unsqueeze__(data_dict[self.data_key],
																			 data_dict[self.seg_key])
		return data_dict
...
class RemoveBatchDimension(YuccaTransform):
	...
	def __call__(self, packed_data_dict = None, **unpacked_data_dict):
		data_dict = packed_data_dict if packed_data_dict else unpacked_data_dict
		data_dict[self.data_key], data_dict[self.seg_key] = self.__squeeze__(data_dict[self.data_key],
																			 data_dict[self.seg_key])
		return data_dict